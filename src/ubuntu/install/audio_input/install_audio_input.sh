...
curl -fL https://cache.ali.wodcloud.com/vscode/kasm/audio_input/kasm_audio_input_server_${ARCH}_${BRANCH}.${COMMIT_ID_SHORT}.tar.gz | tar -xvz -C $STARTUPDIR/audio_input/
